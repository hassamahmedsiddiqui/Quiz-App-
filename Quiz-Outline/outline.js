...
//     if(language === 'html'){
//         selectedTopic = html
//         quizName.innerHTML = 'HTML'
//         }
//         else if (language === 'css'){
//         selectedTopic = css
//         quizName.innerHTML = 'CSS'

//         }
//         else if (language === "js"){
//             selectedTopic = js
//             quizName.innerHTML = 'JavaScript'
...
//             // console.log(html[index-1][`option${selected}`])
//             let userAnswer = selectedTopic[index-1][`option${selected}`]
//             console.log('userAnswer-->',userAnswer)
//             let correctAnswer = selectedTopic[index-1].correctOption
...
//     if(index > selectedTopic.length-1){

//         alert(`Question End your correct answer  is${score} & your wrong answer is ${wrongAnswer} ` )
//     }else{
//     question.innerHTML = selectedTopic[index].question;
//     option1.innerText = selectedTopic[index].option1;
//     option2.innerText = selectedTopic[index].option2;
//     option3.innerText = selectedTopic[index].option3;
//     index++
// }
// }
// // startQuiz()
...
// var html = [
//     // ... (rest of the HTML questions and options remain the same) ...
// ];

// var css = [
//     // ... (rest of the CSS questions and options remain the same) ...
// ];

// var js = [
//     // ... (rest of the JavaScript questions and options remain the same) ...
// ];
...
let score = 0;
let wrongAnswer = 0;
let allQuiz = document.getElementById("all-quiz");
let selectedTopic;
startQuiz = (language) => {
    let options = document.getElementsByName('answer');
    console.log(quizDiv)
